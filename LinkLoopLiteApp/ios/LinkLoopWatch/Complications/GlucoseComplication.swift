...
// MARK: - Circular Complication (Glucose Ring)
...
// MARK: - Rectangular Complication (Value + Trend + Time)
...
// MARK: - Inline Complication (Single line text)
...
// MARK: - Widget Bundle (referenced from LinkLoopWatchApp.swift)

struct LinkLoopComplicationBundle: WidgetBundle {
